window.addEventListener('DOMContentLoaded', () => {
  ...
  function postData(form) {
    form.addEventListener('submit', (e) => {
      ...
      // request.setRequestHeader('Content-type', 'application/json'); для того случая, когда сервер принимает данные в формате json
      ...
      // request.send(json);
      // для того случая, когда сервер принимает данные в формате json
